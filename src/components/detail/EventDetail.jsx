    ...
    <div className="relative mb-4">
      <div className="aspect-video rounded-xl overflow-hidden bg-gray-200">
        <img
          ...
          className={`w-full h-full object-contain ${isPast ? "opacity-75 grayscale" : ""}`}
          loading="lazy"
        />
      </div>
      {images.length > 1 && (
...
const EventDetail = ({ event, colorData }) => {
  ...
  return (
    <div
      ...
      style={{
        backgroundColor:
          dynamicStyles.backgroundColor || "var(--bg-primary, #f9fafb)",
      }}
    >
      ...
      <div
        ...
        style={{
          backgroundColor:
            dynamicStyles.primaryColor || "var(--color-primary, #ffffff)",
          color: dynamicStyles.backgroundColor || "var(--bg-primary, #ffffff)",
          borderBottomColor:
            dynamicStyles.accentColor || "var(--color-accent, #e5e7eb)",
        }}
      >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <nav className="hidden sm:flex items-center gap-2 text-sm text-gray-500">
                ...
                <span>/</span>
                <a href="/agenda" className="hover:text-gray-700">
                  Agenda
                </a>
                <span>/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div>
              ...
              <h1
                className={`text-3xl sm:text-4xl font-bold mb-6 ${isPast ? "text-gray-600" : "text-black"}`}
              >
                {event.Nom}
              </h1>
              ...
              {event.Description && (
                <div
                  className={`prose prose-lg max-w-none ${isPast ? "opacity-75" : ""}`}
                >
                  <div
                ...
                <div className="h-80 rounded-lg overflow-hidden">
                  ...
                  >
                    ...
                    <LeafletComponents.Marker
                      position={[event.Coordonnees.lat, event.Coordonnees.lng]}
                    >
                ...
                {event.Coordonnees && (
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      >
                        {event.Coordonnees.lat.toFixed(4)},{" "}
                        {event.Coordonnees.lng.toFixed(4)}
                        <br />
