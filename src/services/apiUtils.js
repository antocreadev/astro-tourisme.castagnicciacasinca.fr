 ...
 */
export async function fetchAll(endpoint, { populate='*', pageSize=100 } = {}) {
  ...
  try {
    do {
      const url = `${API_BASE_URL}${endpoint}?populate=${encodeURIComponent(populate)}&pagination[page]=${page}&pagination[pageSize]=${pageSize}`;
 ...
 */
export const fetchAllEvenements = (opts={}) => fetchAll('/api/evenements', opts);
export const fetchAllSejourners = (opts={}) => fetchAll('/api/sejourners', opts);
export const fetchAllPlages = (opts={}) => fetchAll('/api/plages', opts);
export const fetchAllArtisanat = (opts={}) => fetchAll('/api/artisanat-et-produits', opts);
export const fetchAllRandonnees = (opts={}) => fetchAll('/api/randonnees', opts);
export const fetchAllActivitesNautiques = (opts={}) => fetchAll('/api/activites-nautiques', opts);
