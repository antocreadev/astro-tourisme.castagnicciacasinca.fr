export async function GET() {
  ...
  const staticPages = [
    ...
    { url: '/carte-interactive', changefreq: 'weekly', priority: '0.9', lastmod },
    { url: '/mentions-legales', changefreq: 'yearly', priority: '0.1', lastmod },
  ];

  // Pages de sections avec métadonnées enrichies
  const sectionPages = [
    { url: '/activite-nautique', changefreq: 'weekly', priority: '0.8', lastmod },
    { url: '/agenda', changefreq: 'daily', priority: '0.8', lastmod },
    { url: '/artisanat', changefreq: 'monthly', priority: '0.8', lastmod },
    { url: '/informations-pratiques', changefreq: 'monthly', priority: '0.7', lastmod },
