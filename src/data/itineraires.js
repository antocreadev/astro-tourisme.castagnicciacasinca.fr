export const itineraires = [
  {
    ...
    description: "Découvrez l'histoire fascinante de la Casinca à travers ses villages chargés d'histoire et ses monuments emblématiques.",
    fullDescription: `
    ...
    stops: [
      {
        ...
        duration: "45 min",
        highlights: ["Église paroissiale", "Architecture traditionnelle", "Point de vue panoramique"]
      },
      {
        name: "Venzolasca", 
        description: "Village authentique et artisanat local",
        duration: "30 min",
        highlights: ["Artisans locaux", "Architecture de schiste", "Produits du terroir"]
      },
      {
        name: "Penta-di-Casinca",
        description: "Belvédère et patrimoine rural",
        duration: "40 min", 
        highlights: ["Point de vue exceptionnel", "Patrimoine agricole", "Sentiers de découverte"]
      },
      {
        name: "Loreto-di-Casinca",
        description: "Destination finale avec patrimoine religieux",
        duration: "50 min",
        highlights: ["Sanctuaire historique", "Art sacré", "Panorama sur la côte"]
      }
    ],
    details: {
      level: "Tout public",
  ...
  },
  {
    ...
    description: "Suivez les anciens canaux d'irrigation qui ont façonné les paysages agricoles de la Casinca.",
    fullDescription: `
    ...
    stops: [
      {
        ...
        duration: "20 min",
        highlights: ["Source naturelle", "Ancien système de captage", "Départ du sentier"]
      },
      {
        name: "Canal principal",
        description: "Suivre le canal d'irrigation principal", 
        duration: "90 min",
        highlights: ["Ouvrage hydraulique", "Faune aquatique", "Végétation ripariale"]
      },
      {
        name: "Belvédère d'Acquatella",
        description: "Point de vue sur la plaine irriguée",
        duration: "30 min",
        highlights: ["Panorama exceptionnel", "Géologie", "Observation ornithologique"]
      },
      {
        name: "Anciens moulins",
        description: "Vestiges de l'activité meunière",
        duration: "40 min", 
        highlights: ["Patrimoine industriel", "Mécanismes anciens", "Histoire locale"]
      }
    ],
    details: {
  ...
  },
  {
    ...
    description: "Explorez les villages perchés authentiques de la Castagniccia, véritables joyaux de l'architecture corse.",
    fullDescription: `
    ...
    stops: [
      {
        ...
        duration: "60 min",
        highlights: ["Maison natale de Paoli", "Musée départemental", "Architecture traditionnelle"]
      },
      {
        name: "Valle-di-Rostino",
        description: "Village viticole historique",
        duration: "45 min", 
        highlights: ["Vignobles en terrasses", "Cave coopérative", "Dégustation locale"]
      },
      {
        name: "Castello-di-Rostino",
        description: "Village fortifié médiéval",
        duration: "50 min",
        highlights: ["Vestiges du château", "Point de vue panoramique", "Architecture défensive"]
      },
      {
        name: "Volpajola",
  ...
  },
  {
    ...
    description: "Immersion dans l'univers du pastoralisme corse à travers bergeries et alpages d'altitude.",
    fullDescription: `
    ...
    stops: [
      ...
      },
      {
        ...
        duration: "90 min",
        highlights: ["Visite de bergerie", "Dégustation fromages", "Rencontre avec le berger"]
      },
      {
        name: "Col de Verde",
      ...
      },
      {
        ...
        duration: "60 min",
        highlights: ["Sommet panoramique", "Chapelle historique", "Spiritualité montagnarde"]
      }
    ],
    details: {
  ...
  },
  {
    ...
    description: "Rencontrez les artisans locaux et découvrez les savoir-faire traditionnels de la région.",
    fullDescription: `
    ...
    stops: [
      {
        ...
        duration: "60 min",
        highlights: ["Démonstration tournage", "Techniques d'émaillage", "Achat direct"]
      },
      {
        name: "Forge de Porri",
        description: "Ferronnerie d'art traditionnelle",
        duration: "45 min",
        highlights: ["Travail du fer forgé", "Outils traditionnels", "Créations contemporaines"]
      },
      {
      ...
      },
      {
        ...
        duration: "45 min",
        highlights: ["Ruches traditionnelles", "Dégustation miels", "Produits dérivés"]
      }
    ],
    details: {
      level: "Tout public",
